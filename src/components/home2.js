            ...
            <div className="flex flex-row justify-between h-20 items-center px-8">
                ...
                <div className="flex flex-row items-center space-x-8">
                    ...
                    <div className="flex flex-row items-center space-x-1 rounded-full nice-blue-color py-1 px-3">
                        <p className="text-md font-medium connect-button">
                            Connect
                        </p>
                ...
                <div className="flex self-center z-10">
                    <div className="flex flex-row space-x-40">
                        <div className="space-y-3">
                            <p className="text-white text-6xl font-medium tracking-wider">
                                Demeter Labs
                            </p>
                            <p className="text-white text-2xl font-normal">
                                Access self-paying loans
                            </p>
                            ...
                            <div>
                                <button
                                    className="text-white text-2xl font-normal bg-blue get-started-button w-96 px-2 py-1 rounded-full tracking-wider mt-5"
            ...
            <div className="features w-screen py-16 px-16 relative ">
                <div className="flex flex-row justify-between">
                    <div className="features-l1 flex flex-col justify-between rounded-3xl">
                        <p className="text-xl text-white font-semibold pl-12 pt-8">
                            Lend Tokens
                        </p>
                ...
                <div className="flex flex-row justify-between">
                    <div className="justify-between features-l2 flex flex-col">
                        <p className="text-white font-semibold text-2xl pl-4 pt-4">
                            Borrow Crypto
                        </p>
                        <p className="text-white font-thin">
                            Leverage your crypto holdings to access liquidity in
